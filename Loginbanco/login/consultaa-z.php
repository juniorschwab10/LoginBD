...
$sql = "SELECT id_users, nome, email, pass
...
if ($stmt) {
  ...
  echo "<h2>Lista de Cadastros</h2>";
    ...
    echo "<tr><th>id_users</th>
		<th>Nome</th><th>email</th><th>pass</th></tr>";
        ...
        while ($linha = $resultado->fetch_assoc()) {
			...
			echo "<td>" .htmlspecialchars($linha['id_users']) ."</td>";
            echo "<td>" . htmlspecialchars($linha['nome']) . "</td>";
            echo "<td>" . htmlspecialchars($linha['email']) . "</td>";
            echo "<td>" . htmlspecialchars($linha['pass']) . "</td>";
            echo "</tr>";
//AULA 27/05/26        
}
        echo "</table>";
