    ...
    <form name="form_pesquisa" id="form_pesquisa" method="post" action="">
        <div id="login-box">
            ...
            <div id="login-box-field">
                <input name="email" type="email" class="form-login" title="Username" size="30" required />
            </div>
            <div id="login-box-name">Senha:</div>
            <div id="login-box-field">
                <input name="pass" type="password" class="form-login" title="Password" size="30" required />
            </div>
            <br/> 
           
            <span class="login-box-options">
                <input type="checkbox" name="remember" value="1"> Permanecer Logado 
                <a href="cad_usuario.php" style="margin-left:30px;">N�o Cadastrado!</a>
            </span>
